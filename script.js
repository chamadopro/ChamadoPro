...
function performLoginV2(event) {
    ...
    if (isClientSelected) {
        ...
        if (clickedButtonId === 'client-login-button-v2') {
            ...
            if (email.toLowerCase() === 'trova@chamadopro.com.br' && password === '12345') { // Novo usuário de exemplo para cliente
        ...
        if (email.toLowerCase() === 'trova@chamadopro.com.br' && password === '12345') { // Novo usuário de exemplo para prestador
