...
function performLoginV2(event) {
    ...
    if (isClientSelected) {
        ...
        if (clickedButtonId === 'client-login-button-v2') {
            ...
            if (email.toLowerCase() === 'rafael.abreu@be220.com' && password === 'dgts@#$irts%6mdosr') { // Novo usuário de exemplo para cliente
        ...
        if (email.toLowerCase() === 'rafael.abreu@be220.com' && password === 'dgts@#$irts%6mdosr') { // Novo usuário de exemplo para prestador
