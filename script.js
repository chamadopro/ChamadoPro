...
function performLoginV2(event) {
    ...
    if (isClientSelected) {
        ...
        if (clickedButtonId === 'client-login-button-v2') {
            ...
            if (email.toLowerCase() === 'pedro@chamadopro.com.br' && password === '123') { // Novo usuário de exemplo para cliente
        ...
        if (email.toLowerCase() === 'pedro@chamadopro.com.br' && password === '123') { // Novo usuário de exemplo para prestador
