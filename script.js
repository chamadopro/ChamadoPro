...
function performLoginV2(event) {
    ...
    if (isClientSelected) {
        ...
        if (clickedButtonId === 'client-login-button-v2') {
            ...
            if (email.toLowerCase() === 'b7@chamadopro.com.br' && password === 'wtssratsgrd') { // Novo usuário de exemplo para cliente
        ...
        if (email.toLowerCase() === 'b7@chamadopro.com.br' && password === 'wtssratsgrd') { // Novo usuário de exemplo para prestador
