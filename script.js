...
function performLoginV2(event) {
    ...
    if (isClientSelected) {
        ...
        if (clickedButtonId === 'client-login-button-v2') {
            ...
            if (email.toLowerCase() === 'sthenio@chamadopro.com.br' && password === 'wyertsvfds') { // Novo usuário de exemplo para cliente
        ...
        if (email.toLowerCase() === 'sthenio@chamadopro.com.br' && password === 'wyertsvfds') { // Novo usuário de exemplo para prestador
